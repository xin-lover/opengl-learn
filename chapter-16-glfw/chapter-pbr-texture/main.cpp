...
glCheckError();
    ...
    shared_ptr<Shader> sh = make_shared<Shader>("./pbr1.2.vert","./pbr1.2.frag");
    sh->Use();
    ...
    sh->SetInt("albedoMap",0);
    sh->SetInt("normalMap",1);
    sh->SetInt("metallicMap",2);
    sh->SetInt("roughnessMap",3);
    sh->SetInt("aoMap",4);
    ...
    shared_ptr<Texture2D> albedoTex = make_shared<Texture2D>("../resources/rusted_iron/albedo.png");
    shared_ptr<Texture2D> normalTex= make_shared<Texture2D>("../resources/rusted_iron/normal.png");
    shared_ptr<Texture2D> metallicTex = make_shared<Texture2D>("../resources/rusted_iron/metallic.png");
    shared_ptr<Texture2D> roughnessTex = make_shared<Texture2D>("../resources/rusted_iron/roughness.png");
    shared_ptr<Texture2D> aoTex = make_shared<Texture2D>("../resources/rusted_iron/ao.png");
...
glCheckError();
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D,albedoTex->Get());
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D,normalTex->Get());
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_2D,metallicTex->Get());
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D,roughnessTex->Get());
        glActiveTexture(GL_TEXTURE4);
        glBindTexture(GL_TEXTURE_2D,aoTex->Get());
        sh->Use();
