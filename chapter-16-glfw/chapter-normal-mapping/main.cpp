...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(kWidth,kHeight,"normal mapping",nullptr,nullptr);
    if(window == nullptr)
    {
    ...
    shared_ptr<Shader> sh = make_shared<Shader>("./normalmapping.vert","./normalmapping.frag");
    sh->Use();
    ...
    shared_ptr<Texture2D> tex = make_shared<Texture2D>("../resources/brickwall.jpg");
    shared_ptr<Texture2D> normalTex = make_shared<Texture2D>("../resources/brickwall_normal.jpg");
